...
public class UserAction extends ActionSupport{
	...
	public String list(){
        ...
        studentMap.put("student3",new User(new Long(3),"����2","����"));   
        ...
        list1.add(new User(new Long(1),"����1","��"));  
        list1.add(new User(new Long(2),"����2","��"));  
        list1.add(new User(new Long(3),"����3","��"));  
        listMap.put("class1", list1); 	          
        List<User> list2=new ArrayList<User>();  
        list2.add(new User(new Long(1),"����1","��"));  
        list2.add(new User(new Long(2),"����2","��"));  
        list2.add(new User(new Long(3),"����3","��"));  
        list2.add(new User(new Long(4),"����4","��"));  
